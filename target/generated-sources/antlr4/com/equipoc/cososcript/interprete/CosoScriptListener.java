...
public interface CosoScriptListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CosoScriptParser#s}.
	 * @param ctx the parse tree
	 */
	void enterS(@NotNull CosoScriptParser.SContext ctx);
	/**
	 * Exit a parse tree produced by {@link CosoScriptParser#s}.
	 * @param ctx the parse tree
	 */
	void exitS(@NotNull CosoScriptParser.SContext ctx);
	/**
